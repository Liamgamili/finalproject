...
LANGUAGE plpgsql AS
    ...
    $$;
---------------------------
SELECT * FROM get_airline_by_username('li@m');
---------------------------
...
LANGUAGE plpgsql AS
    ...
    $$;
----------------------------
SELECT * FROM get_customer_by_username('bl3nd');
----------------------------
...
LANGUAGE plpgsql AS
    ...
    $$;
------------------------
SELECT * FROM get_user_by_username('mor1s');
------------------------
...
LANGUAGE plpgsql AS
    ...
    $$;
-----------------------------
SELECT * FROM get_flights_by_parameters(1, 2, '2022-07  -01 10:10:10');
-----------------------------
